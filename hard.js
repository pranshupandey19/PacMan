...
const gameBackgroundAudio = new Audio("./audio/game-background.mp3")

// const dotEatingAudio = new Audio("./audio/pacman_doteating.wav")

const deathAudio = new Audio("./audio/pacman_death.wav")

const eatGhost = new Audio("./audio/pacman_eatghost.wav")
...
const storedInputValue = localStorage.getItem('storedInput');

document.getElementById("username").textContent = storedInputValue